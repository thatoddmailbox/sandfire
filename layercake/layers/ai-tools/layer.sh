...
echo '{"hasCompletedOnboarding": true, "bypassPermissionsModeAccepted": true, "effortCalloutDismissed": true, "sonnet45MigrationComplete": true, "sonnet45MigrationTimestamp": 1769408052736}' > "${SANDFIRE_HOME}/.claude.json"
