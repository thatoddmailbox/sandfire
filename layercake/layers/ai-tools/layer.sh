...
echo '{"hasCompletedOnboarding": true, "bypassPermissionsModeAccepted": true, "effortCalloutDismissed": true, "sonnet45MigrationComplete": true, "sonnet45MigrationTimestamp": 1769408052736, "opus47LaunchSeenCount": 5, "projects": {"/home/sandfire/workspace": {"hasTrustDialogAccepted": true}}}' > "${SANDFIRE_HOME}/.claude.json"
...
echo '{"cleanupPeriodDays": 99999, "model": "opus[1m]", "respondToBashCommands": false, "statusLine": {"type": "command", "command": "/home/sandfire/.claude/statusline.sh"}, "tui": "default"}' > "${SANDFIRE_HOME}/.claude/settings.json"
...
curl -fsSL https://opencode.ai/install | HOME=/home/sandfire bash -s -- --no-modify-path 2>&1 | cat
...
mkdir -p /home/sandfire/workspace
chown sandfire:sandfire /home/sandfire/workspace
